<template>
  <section class="footer container-custom">
    <div class="footer__nav hidden md:flex">
      ...
      <div class="w-1/5 footer__list footer__list--newsletter">
        <h5>Newsletter</h5>
        ...
        <div class="flex">
          ...
          /><button class="bg-greenFresh text-white footer__button">
            SEND
          </button>
        </div>
        <div>
          <img src="../assets/img/mail.svg" class="inline mr-1 w-4" alt="" />
          <h5 class="inline font-normal text-sm">elemesid@gmail.com</h5>
        </div>
        <div>
          <img src="../assets/img/phone.svg" class="inline mr-1 w-4" alt="" />
          <h5 class="inline font-normal text-sm">0888 1111 2222</h5>
        </div>
      </div>
    </div>
